...
public class ManageJanitorSchedule extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        addScheduleBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        addScheduleBtn.setForeground(new java.awt.Color(140, 82, 255));
        ...
        scheduleTable.setBackground(new java.awt.Color(255, 222, 242));
    ...
    private void addScheduleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addScheduleBtnActionPerformed
        ...
        try {
            ...
            if (roomNumberTxt.getText() != null && timeTxt.getText() != null) {
                ...
                system.getCaretakerShiftList().getScheduleDirectory().add(newSchedule);
        ...
        try {
            ...
            for (CaretakerShift schedule : system.getCaretakerShiftList().getScheduleDirectory()) {
                ...
                if (schedule.getCustomer()!= null) {
                    newRow[4] = (schedule.getCustomer().getFirstName() + " " + schedule.getCustomer().getLastName());
                    newRow[5] = schedule.getCustomer().getCustomerId();
                }
                model.addRow(newRow);
            }
        } catch (Exception e) {

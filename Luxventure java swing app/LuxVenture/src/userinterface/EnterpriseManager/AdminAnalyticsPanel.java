...
public class AdminAnalyticsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel12.setForeground(new java.awt.Color(140, 82, 255));
        ...
        jLabel15.setForeground(new java.awt.Color(140, 82, 255));
        jLabel15.setText("Total requests:");

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(140, 82, 255));
        jLabel16.setText("Vehicle:");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(140, 82, 255));
        jLabel17.setText("Food and Beverages:");

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(140, 82, 255));
        jLabel18.setText("Gaming:");

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(140, 82, 255));
        jLabel19.setText("Laundry Managers:");

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(140, 82, 255));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(janitorTxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(laundryManagerTxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(poolInchargeTxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(266, 266, 266)
    ...
    private void populateFields() {
        ...
        try {
            ...
            for (Customer user : system.getCustomerList().getCustomer()) {
            ...
            for (CustomerPayments transaction : system.getCustomerPaymentsList().getCustomerPaymentsList()) {
                ...
                totalRevenue += transaction.getCheckoutprice();
            }

            totalRequestCount = system.getDiningRoomServiceRequestList().getDiningRoomServiceRequestList().size()
                    + system.getGameRoomServiceRequestList().getGameWorkRequestList().size()
                    + system.getLaundryServiceRequestList().getLaundryServiceRequestList().size()
                    + system.getSwimmingPoolServiceRequestList().getSwimmingPoolServiceRequestList().size()
                    + system.getVehicleServiceRequestList().getVehicleServiceRequestList().size();

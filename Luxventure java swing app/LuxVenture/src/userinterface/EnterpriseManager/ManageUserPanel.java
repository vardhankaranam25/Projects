...
public class ManageUserPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        showRolesTbl.setBackground(new java.awt.Color(255, 222, 242));
        ...
        viewRoleBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        viewRoleBtn.setForeground(new java.awt.Color(140, 82, 255));
        ...
        deleteRoleBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        deleteRoleBtn.setForeground(new java.awt.Color(140, 82, 255));
        ...
        updateRoleBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        updateRoleBtn.setForeground(new java.awt.Color(140, 82, 255));
    ...
    private void viewRoleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewRoleBtnActionPerformed
        ...
        try {
            ...
            String customerId = String.valueOf(model.getValueAt(index, 0));
            Customer selectedUser = system.getCustomerList().getCustomerById(customerId);

            txtUserId.setText(selectedUser.getCustomerId());
            txtFName.setText(selectedUser.getFirstName());
            txtLName.setText(selectedUser.getLastName());
            txtUserName.setText(selectedUser.getCustomerName());
    ...
    private void deleteRoleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRoleBtnActionPerformed
        ...
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) showRolesTbl.getModel();
            String customerID = String.valueOf(model.getValueAt(index, 0));
            Customer selectedCustomer = system.getCustomerList().getCustomerById(customerID);

            system.getCustomerList().getCustomer().remove(selectedCustomer);
    ...
    private void updateRoleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateRoleBtnActionPerformed
        ...
        try {
            ...
            selectedCustomer.setCustomerId(txtUserId.getText());
            selectedCustomer.setFirstName(txtFName.getText());
            selectedCustomer.setLastName(txtLName.getText());
            selectedCustomer.setCustomerName(txtUserName.getText());
            selectedCustomer.setPassword(txtPassword.getText());
            selectedCustomer.setRoleType(String.valueOf(cmbRoleUpdate.getSelectedItem()));
            selectedCustomer.setAddress(txtAddress.getText());
            selectedCustomer.setPhoneNumber(Long.valueOf(txtPhoneNumber.getText()));
            selectedCustomer.setEmailId(txtEmailAddress.getText());
            selectedCustomer.setAge(Integer.parseInt(txtAge.getText()));

            system.getCustomerList().updateCustomer(selectedCustomer);
    ...
    public void displayUserRoles() {
        ...
        try {
            if (cmbRole.getSelectedItem() != null) {
                ...
                ArrayList<Customer> userDetails = system.getCustomerList().getUsersByRole(userRoleType);

                for (Customer users : userDetails) {
                    Object[] newRow = new Object[3];
                    newRow[0] = users.getCustomerId();
